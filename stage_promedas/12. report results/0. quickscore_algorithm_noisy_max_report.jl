...
function quickscore_noisy_max(patientprev::Matrix{Float64}, sens_normal::Matrix{Float64}, sens_medium::Array{Float64,3}, sens_extreme::Matrix{Float64}, method::String)
    ...
    float_df = DataFrame("Fl32"=>Float32,"Fl128"=>Float128,"MF2"=>Float64x2,"MF3"=>Float64x3,"MF4"=>Float64x4,"MF5"=>Float64x5,"BF"=>BigFloat)
    if any(occursin.(names(float_df),method)); float_type = float_df[1,names(float_df)[occursin.(names(float_df),method)][1]]; else; float_type=Float64; end; 
